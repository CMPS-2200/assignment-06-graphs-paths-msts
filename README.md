# CMPS 2200: Assignment 06

In this assignment we'll explore graph algorithms.

To complete this assignment, follow the instructions in [assignment-06.md](assignment-06.md) ([PDF version](assignment-06.pdf)). Below you'll find important and useful information about submitting your work, using git, and testing your code. 
